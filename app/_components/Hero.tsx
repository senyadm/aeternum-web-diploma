...
import { Book, Locate } from 'lucide-react'
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            ...
            words="A
            Pathway to Secure, Transparent, and Globally Recognized Education"
          />
          <p className="text-white text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Navigating the Everlasting Realm of Knowledge
          </p>
          <Link href="/academy">
            <MagicButton position="left" icon={Book} title="AW Academy" />
          </Link>
        </div>
      </div>
    </div>
